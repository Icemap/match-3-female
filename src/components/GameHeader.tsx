...
const GameHeader = ({ score, moves, onMenuClick }: GameHeaderProps) => {
  return (
    <div className="game-header flex items-center justify-between w-full bg-blue-500 rounded-lg px-4 py-2 mb-2 text-white shadow-md border-2 border-blue-400">
      ...
      <div className="moves-display text-right font-bold">
        <div className="text-sm text-blue-100">MOVES</div>
